...
<div style="background: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); max-width: 600px;">
    <form action="{{ route('resources.update', $resource) }}" method="POST">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="name" value="{{ old('name', $resource->name) }}" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="type" value="{{ old('type', $resource->type) }}" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
        ...
        <div style="display: flex; gap: 15px; margin-bottom: 15px;">
            <div style="flex: 1;">
                ...
                <input type="number" name="capacity" value="{{ old('capacity', $resource->capacity) }}" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
            ...
            <div style="flex: 1;">
                ...
                <input type="text" name="unit" value="{{ old('unit', $resource->unit) }}" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
                @error('unit') <span style="color: #dc2626; font-size: 12px;">{{ $message }}</span> @enderror
            </div>
        </div>

        <div style="display: flex; gap: 10px;">
            <button type="submit" style="background: #2563eb; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">Update Resource</button>
